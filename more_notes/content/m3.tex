...
%% ============================================================
\section{List of Lemmas and Proofs:}
%% ============================================================
...
%% ============================================================
\subsection{Several Lemmas and Theorems for Tensors:}
%% ============================================================
...
\end{definition}
\begin{remark}
	Per \ref{rem:1} $i \land j \land k$ shall be non-zero values in $\mathbb{N}$. Moreover the identity shall hold $\mathcal{I}_{kij}^{n} \neq \mathcal{E}_{ijk}^{n}$.
\end{remark}
...
\end{equation}
Where $\mathcal{T}$ of index $k$ is a tensor representing a manifold of four diemensional properties. And $C$ is a residue constant in a arbitary n-plane.
\end{theorem}
