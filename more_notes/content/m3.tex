...
\begin{lemma}
\label{lem:1}
There exist a following identity of factor $p$ of an index of a set $\mathcal{I}$ at $i, j, k$ in $\mathbb{N}^{+}$.
\begin{equation}
...
\begin{definition}
\label{def:1}
Per \ref{lem:1}. Let the equation of $p, n \in \mathbb{N}^{+}$ be defined for a variable $\mathcal{E}$.
\begin{equation}
...
\begin{align*}
	||\mathcal{E}_{ijk}||^{p+n} = (p \cdot \mathcal{I}_{kij})^{n},\\
	\frac{||\mathcal{E}_{ijk}||^{p+n}}{p} = (\mathcal{I}_{k})^{n}, \, \forall \mathcal{E}_{ijk} \neq 0, \, \forall p \neq 0.
\end{align*}
For $i, j, k \subset \mathbb{N}^{+}$.
\end{remark}
\end{definition}
