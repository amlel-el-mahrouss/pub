...
Then:
\begin{equation}
	\mathcal{C}_{0} = \frac{\mathcal{N}(x) - y \cdot \int_{n}^{p} \mathcal{T}_{n} \cdot t \, \partial t}{\pm \mathcal{C}_{\frac{1}{2}}}.
\end{equation}
Where $\mathcal{C}_{0}$ is defined as a remainder of the right side identity.
\end{remark}
