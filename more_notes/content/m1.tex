...
\begin{remark}
An equation that requires $\mathcal{C}$ to be non-zero and convergent over a subset $\mathbb{D}$.\\
Assuming $\mathcal{C} = \mathcal{C}_{0} + \mathcal{C}_{\frac{1}{2}}.$:
\begin{equation}
	\mathcal{C} = \mathcal{N}(x) - y \cdot \int_{n}^{p} \mathcal{T}_{n} \cdot t \, dt.
\end{equation}
Then:
\begin{equation}
	\mathcal{C}_{0} = \frac{\mathcal{N}(x) - y \cdot \int_{n}^{p} \mathcal{T}_{n} \cdot t \, dt}{\pm \mathcal{C}_{\frac{1}{2}}}.
\end{equation}
Where $\mathcal{C}_{0}$ is defined as a remainder of the right hand side, then for a non-zero $\mathcal{N}(x)$.:
\begin{equation}
	\frac{\mathcal{C}_{0}}{\pm \mathcal{N}(x) } = \frac{-y \cdot \int_{n}^{p} \mathcal{T}_{n} \cdot t \, dt}{\pm \mathcal{C}_{\frac{1}{2}}}.
\end{equation}
\end{remark}
...
\end{align*}
Consider a set of derivatives $t_p$ below written as the following for $y_p \neq 0$ and $y_p! \neq 0$.:
\begin{align*}
	\mathcal{S} &= \{ \frac{\partial t_p}{\partial x} \frac{\Delta x_p}{y_p!}, \, \dots \}, \, p \neq 0.
\end{align*}
\end{remark}
