...
\lettrine[lines=1, lhang=0.1, loversize=0.2]{I}N this paper we will cover the convective form of the Cauchy Momentum Equation as stated per Navier-Stokes. And proceed to conduct several observations on the said equation.\\
Results and more remarks will be given throughout the paper.

%% ============================================================
\section{Introduction and Definitions before Proofs:}
%% ============================================================
\subsection{Introduction and Notions:}
...
\begin{remark}
\label{rem:1}
  Let the material derivative be defined as: $\frac{\mathbf{D}\textbf{u}}{\mathbf{D}t}$.
\end{remark}
\begin{remark}
\label{rem:2}
...
\begin{remark}
\label{rem:3}
  Let the flow density variable be defined as: $\textbf{u}$.
\end{remark}
\begin{remark}
\label{rem:4}
...
\end{definition}
\begin{remark}
  There shall be $p \geq 0$, and $\mathbb{R}^{+}_0 \neq \mathbb{R}^{+}_p \land \mathbb{R}^{+}_p > \mathbb{R}^{+}_0$.
\end{remark}
\begin{definition}
...
\end{definition}
\begin{remark}
The plane per \ref{def:plane-1} is assumed non-degenerate and of fourth dimensional space.
\end{remark}
...
\subsection{Proofs of existence of the integral \ref{eq:integral:1} in a 4D-plane:}

\subsection{Application of Proof in applied 4D-planes:}

%% ============================================================
\section{Conclusion:}
%% ============================================================
Per the stated abstract, the paper has fulfilled its purpose, additional graphs and results will be published after writing.

\nocite{*}
\bibliographystyle{acm}
%% TODO: More references.
\bibliography{pinter2010book, simons1968, weil1967basic}
