...
\subsection{Several Applications from Equaition~\ref{eq:cauchy}.}
...
\begin{equation}
  \label{eq:integral:1}
  \int_{\mathbb{R}^{+}}^{+\infty} \rho \frac{\mathbf{D}\textbf{u}}{\mathbf{D}t} \, d\textbf{u} = - \int_{\mathbb{R}^{+}}^{+\infty} \nabla p + \nabla \cdot \tau + \rho \, \textbf{a} \, d\textbf{u}.
\end{equation}
\begin{example}
  ...
  \begin{equation}
      - \int_{\mathbb{R}^{+}}^{x} \nabla p + \nabla \cdot \tau + \rho \, \textbf{a} \, d\textbf{u} \pm \int_{x}^{+\infty} \nabla p + \nabla \cdot \tau + \rho \, \textbf{a} \, d\textbf{u}.
  \end{equation}
