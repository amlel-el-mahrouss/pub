...
\begin{align*}
	...
	\exists \pi^{\frac{1}{12}} &> x, \forall x \neq 0, \forall x \in \mathbb{R}.
\end{align*}
\end{theorem}
\begin{proof}
Per Theorem~\ref{theo:first-zeta}. Let the following in $\mathbb{R}$ by induction.:\\(i) By the property of $\pi^{\frac{1}{12}}$ being transcendental, by the previously stated inequality in $\mathbb{R}.$:
\begin{align*}
...
\begin{remark}
	...
	\begin{align*}
		\pi^{\frac{1}{12}} - \sum_{n=1}^{p}\frac{\zeta(3)}{\pi} + \frac{\pi^{\frac{13}{12}}}{\zeta(3)}.
	\end{align*}
	One may explore the following equations, and identities in a domain $\mathbb{D}.$:
	\begin{align*}
		\pi^{\frac{1}{12}} - \sum_{n=1}^{p}\frac{\zeta(3)}{\pi} &= \mathcal{H}_n,\\
		\mathcal{P}_n &= \frac{\pi^{\frac{13}{12}}}{\zeta(3)}.
	\end{align*}
\end{remark}
\begin{remark}
\label{remark:frac-zeta}
	...
	\begin{equation}
		\mathcal{P} = \frac{\pi^{\frac{13}{12}}}{\zeta(3)} = \mathcal{P}_\phi
	\end{equation}
	We can also write the following generalization for $\mathcal{P}_k$ in $\mathbb{R}$:
	\begin{align*}
		\mathcal{P}_k &= \frac{\pi^{\frac{13}{12}}}{\zeta(k)}.
	\end{align*}
\end{remark}
\begin{remark}
	...
	\end{align*}
	Where $\mathcal{P}_k$ is a near approximation of $\zeta(3)$ in a Dirichlet series.  For $p \neq 0, p \in \mathbb{N}$. Noting the expression $\frac{\zeta(3)}{\pi}$, we will write the following theorems:
\end{remark}
\begin{theorem}
There exist the following equation in $\mathbb{R}.$ And $\forall a, q, k \in \mathbb{R}.$ And $p \in \mathbb{N}.$:
\begin{align*}
	\sum_{k=1}^{p} \frac{f(a, qk)}{k} + (\pi^{\frac{1}{12}} - \frac{\zeta(3)}{\pi}) - \pi &= 0,
\end{align*}
Then moving the left-hand-side $\pi$ to a right-hand-side $\pm \pi$.:
\begin{align*}
	\sum_{k=1}^{p} \frac{f(a, qk)}{k} + (\pi^{\frac{1}{12}} - \frac{\zeta(3)}{\pi}) &= \pm \pi.
\end{align*}
And an alternate forms by dividing $\zeta(3)$ to the right-hand-side or by also moving $(\pi^{\frac{1}{12}} - \frac{1}{\pi})$ to the right-hand-side.:
\begin{align*}
	\sum_{k=1}^{p} \frac{f(a, qk)}{k} + (\pi^{\frac{1}{12}} - \frac{1}{\pi}) &= \pm \frac{\pi}{\zeta(3)},\\
	\sum_{k=1}^{p} \frac{f(a, qk)}{k} &= \pm \frac{\pi}{\zeta(3)} - (\pi^{\frac{1}{12}} - \frac{1}{\pi}) .
\end{align*}
\end{theorem}
\begin{remark}
...
\end{remark}
\begin{corollary}
Per Remark~\ref{remark:sum-both}, we define $\sum_{k=1}^{p} \frac{f(a, qk)}{k} = \pm \frac{\pi}{(\pi^{\frac{1}{12}} - \frac{\zeta(3)}{\pi})}$ to be less than $\pi$ in $\mathbb{R}$.  Moving on to the next section, additional theorems will be stated.
\end{corollary}
% =============================================
...
\begin{theorem}
\label{theo-1}
	For a set $\mathcal{S} \subset \mathbb{D}$ in an arbitrary domain $\mathbb{D}$:\\
