...
\end{align*}
Where $C_k$ is a non-zero constant term in $\mathbb{R}$. Where $\mathcal{X}$ is a sum of tensor products of $\mathcal{T}_k$ and $\mathcal{Y}_k$ for a sequence $k=1, 2, \ldots$ that holds for $\mathbb{N}$. Such that $\forall F(x) \in \mathbb{R}$ and $F(x) \subset \mathcal{T}$. Thus for $\mathcal{X}_n$ being part of a subset $\mathbb{D}$:
\begin{equation}
	\forall \mathcal{X}_n \neq 0, \, \mathcal{X}_n \subset \mathbb{D}, \, \mathbb{D} \subset \mathbb{R}.
\end{equation}
